...
", this.ConnessioneSmart,
                ...
                new ColonnaParametroTabella("DataDocumento", ColonnaParametroTabella.TipiDati.Data, "DATA_DOCUMENTO"),
                ...
                new ColonnaParametroTabella("IDAnagraficaDestinatario", ColonnaParametroTabella.TipiDati.Alfanumerico, "INDIRIZZO"),
                new ColonnaParametroTabella("IDAliquotaIVA", ColonnaParametroTabella.TipiDati.Alfanumerico, "TIV_CODICE"),
...
",
                ...
                new ColonnaParametroTabella("DataIniziale", ColonnaParametroTabella.TipiDati.Data, "DATA_INIZIO"),
                new ColonnaParametroTabella("DataFinale", ColonnaParametroTabella.TipiDati.Data, "DATA_FINE"),
                new ColonnaParametroTabella("IDUnitaDiMisura", ColonnaParametroTabella.TipiDati.Alfanumerico, "TUM_CODICE"),
                new ColonnaParametroTabella("IDValuta", ColonnaParametroTabella.TipiDati.Alfanumerico, "TVA_CODICE"),
                new ColonnaParametroTabella("Prezzo", ColonnaParametroTabella.TipiDati.NumeroDecimale, "PREZZO"),
                new ColonnaParametroTabella("Note", ColonnaParametroTabella.TipiDati.Alfanumerico, "NOTE"),
            ...
            using (TabellaDati datiDestinazioniAnagrafiche = this.RilevaTabellaDatiDaQuery("DestinazioniAnagrafiche"))
            {
                ...
                for (int i = 0; i < datiAnagrafiche.NumeroRighe; i++)
                {
                    ...
                    var anagrafica = new RigaDatiAnagrafiche
                    {
                        ...
                        // IDAnagraficaDestinatario = datiDestinazioniAnagrafiche[i, "IDAnagraficaDestinazione"].ToTrimmedString() == "" ? datiAnagrafiche[i, "IDAnagrafica"].ToTrimmedString() : datiAnagrafiche[i, "IDAnagrafica"].ToTrimmedString() + "_" + datiDestinazioniAnagrafiche[i, "IDAnagraficaDestinazione"].ToTrimmedString(),
            ...
            using (TabellaDati datiRigheListini = this.RilevaTabellaDatiDaQuery("RigheListini"))
            {
                ...
                for (int i = 0; i < datiRigheListini.NumeroRighe; i++)
                {
                    ...
                    var righeListini = new RigaDatiRigheListini
                    {
                        ...
                        DataIniziale = datiRigheListini[i, "DataIniziale"].ToDateTime().ToStringaYYYYMMDD(),
                        DataFinale = datiRigheListini[i, "DataFinale"].ToDateTime().ToStringaYYYYMMDD(),
            ...
            using (TabellaDati datiTestataFatture = this.RilevaTabellaDatiDaQuery("Fatture"))
            {
                ...
                for (int i = 0; i < datiTestataFatture.NumeroRighe; i++)
                {
                    ...
                    var testataFatture = new RigaDatiDocumenti
                    {
                        ...
                        DataDocumento = datiTestataFatture[i, "DataDocumento"].ToDateTime().ToStringaYYYYMMDD(),
                        ...
                        IDAnagraficaDestinatario = datiTestataFatture[i, "IDAnagraficaDestinatario"].ToTrimmedString() == string.Empty ? datiTestataFatture[i, "IDAnagraficaIntestatario"].ToTrimmedString() : datiTestataFatture[i, "IDAnagraficaIntestatario"].ToTrimmedString() + "_" + datiTestataFatture[i, "IDAnagraficaDestinatario"].ToTrimmedString(),
            ...
            using (TabellaDati datiTestataDdt = this.RilevaTabellaDatiDaQuery("Ddt"))
            {
                ...
                for (var i = 0; i < datiTestataDdt.NumeroRighe; i++)
                {
                    ...
                    var testataDdt = new RigaDatiDocumenti
                    {
                        ...
                        DataDocumento = datiTestataDdt[i, "DataDocumento"].ToDateTime().ToStringaYYYYMMDD(),
                        ...
                        IDAnagraficaDestinatario = datiTestataDdt[i, "IDAnagraficaDestinatario"].ToTrimmedString() == string.Empty ? datiTestataDdt[i, "IDAnagraficaIntestatario"].ToTrimmedString() : datiTestataDdt[i, "IDAnagraficaIntestatario"].ToTrimmedString() + "_" + datiTestataDdt[i, "IDAnagraficaDestinatario"].ToTrimmedString(),
