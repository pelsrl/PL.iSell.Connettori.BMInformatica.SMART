...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RigaInserisciBody :  IEquatable<RigaInserisciBody>, IValidatableObject
    {
        /// <summary>
        /// Tipo di movimento
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RigaInserisciBody" /> class.
        /// </summary>
        /// <param name="idOvt">ID dell&#x27;ordine (required).</param>
        /// <param name="descrizione">Descrizione della riga dell&#x27;ordine (default to &quot;&quot;).</param>
        /// <param name="artCodice">Codice dell&#x27;articolo (default to &quot;&quot;).</param>
        /// <param name="quantita">Quantità.</param>
        ...
        public RigaInserisciBody(int? idOvt = default(int?), string descrizione = "", string artCodice = "", int? quantita = default(int?), string tsmCodice = "", string tsmCodiceArt = "", string tivCodice = "", float? prezzo = default(float?), string note = "", TipoMovimentoEnum? tipoMovimento = TipoMovimentoEnum.Normale)
        {
            // to ensure "idOvt" is required (not null)
            if (idOvt == null)
            {
                throw new InvalidDataException("idOvt is a required property for RigaInserisciBody and cannot be null");
            }
            else
            {
                this.IdOvt = idOvt;
            }
            // use default value if no "descrizione" provided
            if (descrizione == null)
            {
                this.Descrizione = "";
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RigaInserisciBody {\n");
        ...
        {
            return this.Equals(input as RigaInserisciBody);
        }

        /// <summary>
        /// Returns true if RigaInserisciBody instances are equal
        /// </summary>
        /// <param name="input">Instance of RigaInserisciBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RigaInserisciBody input)
        {
            if (input == null)
                return false;
