...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OrdineInserisciBody :  IEquatable<OrdineInserisciBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrdineInserisciBody" /> class.
        /// </summary>
        ...
        /// <param name="dataConsegna">Data di consegna.Deve essere uguale o successiva alla data del documento. Se la data di consegna è precedente alla data del documento, verrà generato un errore.  (default to &quot;&quot;).</param>
        ...
        /// <param name="tsmCodice">Codice dello sconto (default to &quot;&quot;).</param>
        ...
        public OrdineInserisciBody(string cliCodice = "", string tmaCodice = "", string tdoCodice = "", string indCodice = "", string numeroDocumento = "", string dataDocumento = "", string dataConsegna = "", string descrizione1 = "", string descrizione2 = "", string via = "", string cap = "", string citta = "", string provincia = "", string tvaCodice = "", string tpaCodice = "", string tlvCodice = "", string tsmCodice = "", string tagCodice = "", string codiceContratto = "", string note = "", List<ApiordineinserisciRighe> righe = default(List<ApiordineinserisciRighe>))
        {
            // to ensure "cliCodice" is required (not null)
            if (cliCodice == null)
            {
                throw new InvalidDataException("cliCodice is a required property for OrdineInserisciBody and cannot be null");
            }
            else
            {
            ...
            if (righe == null)
            {
                throw new InvalidDataException("righe is a required property for OrdineInserisciBody and cannot be null");
            }
            else
            {
                this.Righe = righe;
        ...
        /// <summary>
        /// Data di consegna.Deve essere uguale o successiva alla data del documento. Se la data di consegna è precedente alla data del documento, verrà generato un errore. 
        /// </summary>
        /// <value>Data di consegna.Deve essere uguale o successiva alla data del documento. Se la data di consegna è precedente alla data del documento, verrà generato un errore. </value>
        ...
        /// Codice dello sconto
        /// </summary>
        /// <value>Codice dello sconto</value>
        ...
        public List<ApiordineinserisciRighe> Righe { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrdineInserisciBody {\n");
        ...
        {
            return this.Equals(input as OrdineInserisciBody);
        }

        /// <summary>
        /// Returns true if OrdineInserisciBody instances are equal
        /// </summary>
        /// <param name="input">Instance of OrdineInserisciBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrdineInserisciBody input)
        {
            if (input == null)
                return false;
