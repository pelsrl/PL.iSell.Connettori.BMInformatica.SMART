...
{
    /// <summary>
    /// ApiordineinserisciRighe
    /// </summary>
    [DataContract]
        public partial class ApiordineinserisciRighe :  IEquatable<ApiordineinserisciRighe>, IValidatableObject
    {
        /// <summary>
        /// Tipo di movimento
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiordineinserisciRighe" /> class.
        /// </summary>
        /// <param name="descrizione">Descrizione della riga dell&#x27;ordine (required).</param>
        /// <param name="artCodice">Codice dell&#x27;articolo.</param>
        /// <param name="quantita">Quantità.</param>
        /// <param name="tsmCodice">Codice sconto.</param>
        /// <param name="tsmCodiceArt">Codice sconto articolo.</param>
        /// <param name="tivCodice">Codice dell&#x27;IVA.</param>
        ...
        public ApiordineinserisciRighe(string descrizione = default(string), string artCodice = default(string), float? quantita = default(int?), string tsmCodice = default(string), string tsmCodiceArt = default(string), string tivCodice = default(string), float? prezzo = default(float?), string note = default(string), TipoMovimentoEnum? tipoMovimento = default(TipoMovimentoEnum?))
        {
            ...
            if (descrizione == null)
            {
                throw new InvalidDataException("descrizione is a required property for ApiordineinserisciRighe and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiordineinserisciRighe {\n");
        ...
        {
            return this.Equals(input as ApiordineinserisciRighe);
        }

        /// <summary>
        /// Returns true if ApiordineinserisciRighe instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiordineinserisciRighe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiordineinserisciRighe input)
        {
            if (input == null)
                return false;
